<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="ArduiboProjet.Home" %>
                    ...
                    <div class="inner">
                        ...
                        <nav>
                            <ul class="nav masthead-nav">
                                ...
                                <li>
                                    <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="White" NavigateUrl="~/startPage.aspx">LOG OUT</asp:HyperLink>
                                </li>
