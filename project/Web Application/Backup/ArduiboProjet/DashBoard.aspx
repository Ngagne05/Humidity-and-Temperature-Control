                ...
                <div>
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/166643/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line">
                                </iframe>
                            </div>
                            <div class="col-md-6">
                                <iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/166643/charts/2?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&type=line">
                                </iframe>
                            </div>
                        </div>
                    </div>
                                ...
                                <div>
                                    <div style="float: right; position: relative;">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:ImageButton ID="ImageButton1" runat="server" Width="200px" Height="150px" 
                                                        ImageUrl="~/image/images.jpg" onclick="ImageButton1_Click" />
                                                </td>
                                            </tr>
                                            <tr>
